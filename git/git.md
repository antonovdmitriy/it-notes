...
- [Работа с репозиторием](#работа-с-репозиторием)
  - [Инициализация репозитория на клиенте](#инициализация-репозитория-на-клиенте)
  - [Инициализация репозитория на сервере](#инициализация-репозитория-на-сервере)
    - [Преобразование обычного репозитория в пустой](#преобразование-обычного-репозитория-в-пустой)
  - [Получение репозитория с сервера](#получение-репозитория-с-сервера)
- [](#)
...
## Инициализация репозитория на клиенте
